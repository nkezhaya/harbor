defmodule Harbor.Web.ConnCase do
  ...
  def register_and_log_in_user(context) do
    ...
    do_register_and_log_in_user(context, user)
  end
  ...
  It stores an updated connection and a registered admin in the test context.
  """
  def register_and_log_in_admin(context) do
    user = Harbor.AccountsFixtures.admin_fixture()
    do_register_and_log_in_user(context, user)
  end

  defp do_register_and_log_in_user(%{conn: conn} = context, user) do
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Harbor.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
